...
selected_samples <- grepl("CRC", colnames(expVal)) |
                    grepl("PAAD", colnames(expVal)) |
                    grepl("HBC", colnames(expVal))

X <- t(expVal[top_genes, selected_samples])

y <- ifelse(grepl("CRC", colnames(expVal)), "CRC",
     ifelse(grepl("PAAD", colnames(expVal)), "PAAD",
     ifelse(grepl("HBC", colnames(expVal)), "HBC", NA)))

y <- factor(y, levels = c("CRC", "PAAD", "HBC"))
