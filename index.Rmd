...
columnColour[columnColour == "Healthy"] <- "white"

useColumns <- !is.na(columnColour)

top100Var <- names(sort(-apply(expVal, 1, var)))[1:100] # just for reference

coolmap(expVal[top100Var, useColumns],
