...
# Make a copy and wrap long pathway names in a new column
# Upgregulated
#trimmedCam_up <- dplyr::filter(trimmedCam, Direction == "Up")
#trimmedCam_wrapped <- trimmedCam_up
#rownames(trimmedCam_wrapped) <- str_wrap(str_replace_all(rownames(trimmedCam_wrapped), "_", " "), width = 30)

#trimmedCam_wrapped[[3]] <- sprintf("%.1e", trimmedCam_wrapped[[3]])

#trimmedCam_wrapped[1:25, 1:4] %>%
#  kbl(escape = FALSE) %>%
#  kable_paper(full_width = TRUE) %>%
#  column_spec(1, width = "30em", bold = TRUE) %>%
#  column_spec(2, width = "10em", bold = TRUE) %>%
#  column_spec(3, width = "10em", bold = TRUE) %>%
#  column_spec(4, width = "10em", bold = TRUE) %>%
#  column_spec(5, width = "10em", bold = TRUE)
